...
import 'mass_converter_model.dart';
export 'mass_converter_model.dart';

class MassConverterWidget extends StatefulWidget {
  const MassConverterWidget({super.key});

  @override
  State<MassConverterWidget> createState() => _MassConverterWidgetState();
}

class _MassConverterWidgetState extends State<MassConverterWidget> {
  late MassConverterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MassConverterModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<double>(
                      ...
                      optionLabels: const ['kg.', 'g.', 'mg.', 'tn.', 'lbs', 'oz'],
                      onChanged: (val) =>
