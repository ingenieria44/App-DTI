...
import 'velocityconv_model.dart';
export 'velocityconv_model.dart';

class VelocityconvWidget extends StatefulWidget {
  const VelocityconvWidget({super.key});

  @override
  State<VelocityconvWidget> createState() => _VelocityconvWidgetState();
}

class _VelocityconvWidgetState extends State<VelocityconvWidget> {
  late VelocityconvModel _model;
