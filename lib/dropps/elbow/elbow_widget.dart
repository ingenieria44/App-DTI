...
import 'elbow_model.dart';
export 'elbow_model.dart';

class ElbowWidget extends StatefulWidget {
  const ElbowWidget({super.key});

  @override
  State<ElbowWidget> createState() => _ElbowWidgetState();
}

class _ElbowWidgetState extends State<ElbowWidget> {
  late ElbowModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ElbowModel());
